          ...
          <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? "hover:bg-red-100 hover:border-t-4 hover:border-red-900 rounded-none  text-red-900 h-16 flex items-center"
                            : "hover:bg-red-100 hover:border-t-4 hover:border-red-900 rounded-none  text-red-900 flex items-center",
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <input type="text" placeholder="Søk....." aria-label="Search" />
                <button
                  type="button"
