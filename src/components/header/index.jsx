...
const SearchBar = () => {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="relative p-1 text-red-900 hover:text-red-900"
      >
        {SearchIcon}
      ...
      <input
        type="text"
        placeholder="Søk....."
        className={`w-full py-2 pl-8 pr-4 border border-gray-300 focus:outline-none focus:border-red-900 ${
          ...
          <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <Disclosure.Button className="relative inline-flex items-center justify-center p-2 text-red-900 hover: hover:boder focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ...
                      : "text-gray-300 hover:bg-gray-700 hover:text-red-300",
